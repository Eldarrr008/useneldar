      ...
      <footer className="border-t bg-card">
        <div className="container mx-auto px-6 py-8">
          ...
          <div className="mt-8 pt-6 border-t flex flex-col items-center gap-3">
            <span className="text-sm text-muted-foreground">{t('landing.footer.followUs', 'Следите за нами')}</span>
            <div className="flex items-center gap-4">
              <a
                href="#"
                aria-label="Instagram"
                className="group flex items-center justify-center h-11 w-11 rounded-full bg-gradient-to-br from-purple-500 via-pink-500 to-orange-400 text-white shadow-md hover:shadow-lg hover:scale-110 transition-all"
              >
              ...
              <a
                href="#"
                aria-label="TikTok"
                className="group flex items-center justify-center h-11 w-11 rounded-full bg-foreground text-background shadow-md hover:shadow-lg hover:scale-110 transition-all"
              >
